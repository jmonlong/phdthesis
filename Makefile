...
clean:
	rm -fr auto main.blg main.bbl main.toc main.out main.lot main.lof main.pdf main.4ct main.aux main.xref main.log main.dvi main.4tc main.html main.lg main.idv main.tmp main.css main.epub LaTeXML.* ltx-report.css main*x.png main-details.blg main-details.bbl main-details.toc main-details.out main-details.lot main-details.lof main-details.pdf main-details.4ct main-details.aux main-details.xref main-details.log main-details.dvi main-details.4tc main-details.html main-details.lg main-details.idv main-details.tmp main-details.css main-details.epub main.ps comment.cut
